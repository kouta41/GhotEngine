...
void GraphicsPipeline::CreatePipeline(PipelineState& pso) {
	...
	pso.BlinnPhongObject3D = CreateBlinnPhongObject3D(device.Get(), L"Blinn-Phong");
...
/// <param name="shaderName"></param>
/// <returns></returns>
Property GraphicsPipeline::CreateBlinnPhongObject3D(Microsoft::WRL::ComPtr<ID3D12Device> device, const std::wstring& shaderName)
{
	Property property;
